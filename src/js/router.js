;(function($) {	
  ...
  var mod = $.sammy('#pnlBody', function() {
    ...
    */
    ...
    this.get('#facturar',        function(){this.partial(vw+'/facturacion/emisionFacturas.html');});
    this.get('#clientes',        function(){this.partial(vw+'/facturacion/listaClientes.html');});
    this.get('#parametricas',        function(){this.partial(vw+'/facturacion/listaContratos.html');});
    this.get('#perfilOffLine',        function(){this.partial(vw+'/facturacion/listaContratos.html');});
    /**QR*/
